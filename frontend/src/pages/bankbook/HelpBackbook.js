  ...
  const Content = () => {
    if (props.page === 1) {
      return (
        <Container>
          <Title>"통장"이란?</Title>
          <Describe>통장은 금융거래를 할 때의 거래 내역을 기록한 문서를 말해요.</Describe>
        </Container>
      )
    }
      ...
      return (
        <Container>
          ...
          <Describe>부모님의 <Bold>{boldtext[0]}</Bold>과 <Bold>{boldtext[1]}</Bold>, <Bold>{boldtext[2]}</Bold> <br />(내 도장이나 부모님 도장)이 필요해요.</Describe>
        </Container>
      )
    }
      ...
      return (
        <Container>
          <SubTitle>통장을 만들기 위해서는?</SubTitle>
          <Describe>부모님과 함께 은행에 가서 <Bold>{boldtext[3]}</Bold>를 작성해요. <br />(이름, 주소, 주민등록번호)</Describe>
      ...
      return (
        <Container>
          <SubTitle>통장을 만들기 위해서는?</SubTitle>
          <Describe>사용할 비밀번호 <Bold>{boldtext[4]}</Bold>를 입력해요. <br />이 때 비밀번호는 연속된 숫자나 생년월일 처럼 쉬운 숫자는 피해야 해요.</Describe>
        </Container>
      )
    }
      ...
      return (
        <Container>
          <Describe>계좌 번호는 은행의 통장을 발급받을 때 부여 받을 수 있어요.</Describe>
        </Container>
      )
    }
      ...
      return (
        <Container>
          <Describe>계좌번호를 알고 있으면 상대방에게 돈을 보낼 수 있어요.</Describe>
        </Container>
      )
    }
