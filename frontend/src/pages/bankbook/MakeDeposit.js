...
const MakeDeposit = () => {
  ...
  const handleBtnClicked = (event) => {
    ...
    // 2주일
    if (value === "2주") {
      const weeks = new Date(currentDate.getTime() + 2 * 7 * 24 * 60 * 60 * 1000);
      setStartDate(new Date());
      setEndDate(weeks);
    }
    // 1개월
    if (value === "4주") {
      const weeks = new Date(currentDate.getTime() + 4 * 7 * 24 * 60 * 60 * 1000);
      // let month = new Date(
      ...
      // 2개월
      if (value === "8주") {
      const weeks = new Date(currentDate.getTime() + 8 * 7 * 24 * 60 * 60 * 1000);
      // let month = new Date(
        //   new Date().getFullYear(),
        //   new Date().getMonth() + 2,
        //   new Date().getDate()
      ...
      // 3개월
      if (value === "12주") {
      const weeks = new Date(currentDate.getTime() + 12 * 7 * 24 * 60 * 60 * 1000);
      // let month = new Date(
        //   new Date().getFullYear(),
        //   new Date().getMonth() + 3,
        //   new Date().getDate()
      ...
      // 6개월
      if (value === "24주") {
      const weeks = new Date(currentDate.getTime() + 24 * 7 * 24 * 60 * 60 * 1000);
